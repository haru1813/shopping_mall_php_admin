                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input id="harumarket_productSize_name" type="text" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" style="height:31px;">
                                </div>
                            </div>
                        </div>
                    </div>
...
<form name="insertForm">
    <div class="modal" tabindex="-1" id="productSize_manager_insertModal">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input name="harumarket_productSize_name" type="text" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" style="height:31px;">
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="modal" tabindex="-1" id="productSize_manager_updateModal">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
...
<script src="./productSize_manager.js?v=<?php echo rand(); ?>"></script>
