                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                ...
                                <label class="input-group-text" for="inputGroupSelect01">성별</label>
                                    <select id="haruMarket_user_gender" class="form-select" style="height:31px;">
                    ...
                    <div class="container-fluid pt-1">
                        <div class="row">
                            <div class="col-3">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text" id="basic-addon1">아이디</span>
                                    <input name="haruMarket_user_id" type="text" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" style="height:31px;">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text" id="basic-addon1">이름</span>
                                    <input name="haruMarket_user_name" type="text" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" style="height:31px;">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="input-group input-group-sm">
                            ...
                            <div class="col-3">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input name="haruMarket_user_birthday" type="date" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" style="height:31px;">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text" id="basic-addon1">핸드폰 번호</span>
                                    <input name="haruMarket_user_phone" type="text" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" style="height:31px;">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="input-group input-group-sm">
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="input-group input-group-sm">
                                    <input name="haruMarket_user_postCode" type="text" class="form-control" placeholder="우편 번호" style="height:31px;" disabled readonly>
                                    <button class="btn btn-outline-secondary" type="button" id="address_search" style="height:31px;">검색</button>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="input-group input-group-sm">
                                    <input name="haruMarket_user_basicAddress" type="text" class="form-control" placeholder="기본 주소" style="height:31px;" disabled readonly>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="input-group input-group-sm">
                                    <input name="haruMarket_user_detailAddress" type="text" class="form-control" placeholder="상세 주소" style="height:31px;">
                                </div>
                            </div>
                        </div>
                    </div>
